    ...
    <div class="container-fluid pb-0">
        ...
        <div class="col-12">
            ...
            <script type="text/javascript">
                $('#create').submit(function() { // catch the form's submit event
                    $.ajax({ // create an AJAX call...
                        type: 'POST',
                        url: '/channels/update_action/<?php echo $data->channels_id; ?>',
            ...
            <div class="setting-card">
                <form id="create" method="post" action="/channels/update_action/<?php echo $data->channels_id; ?>" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-12">
                                    <div class="form-group ">
                                        ...
                                        <!-- toggle switch -->
                                        <!-- common inputs -->
                                        <input name="channels_name" type="text" class="form-control " placeholder="Enter Channel Name" value="<?php echo $data->channels_name; ?>" required>
                                    </div>                           
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-grou ">
                                        ...
                                        <!-- textarea input -->
                                        <textarea name="channels_description" class="form-control" placeholder="Description" required><?php echo $data->channels_description; ?></textarea>
                                    </div>                                
                                </div>
                            </div>
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="channels_slug" class="form-control" value="<?php echo $data->channels_slug; ?>" required> 
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group ">
                                        ...
                                        <!-- toggle switch -->
                                        <!-- common inputs -->
                                        <input name="channels_rating" type="text" class="form-control " placeholder="ie. PG-13" value="<?php echo $data->channels_rating; ?>" required>
                                    </div>                                
                                </div>
                                <div class="col-lg-12">
                                    <label class="form-label flex-grow-1" for="Genres"><strong>Category</strong> <span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <select id="channels_categories_id" name="channels_categories_id" type="select" class="form-control">
                                        <?php foreach($categories_data as $category){ ?>
                                                <option value="<?php echo $category->categories_id; ?>" <?php if($data->channels_categories_id == $category->categories_id){ ?>selected<?php } ?>><?php echo $category->categories_name; ?></option>
                                            <?php } ?>
                                         </select>
                                    </div>
                                </div>
