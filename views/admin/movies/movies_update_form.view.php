...
/*                    if($("#videoToUpload")[0].files.length) {
                       ...
                       //formdata.append("videoToUpload", videoToUpload);
                        ...
                        $.ajax({ // update an AJAX call...
                            type: 'POST',
                            url: '/admin/movies/update_video/<?php //echo $data['movies_id']; ?>/',
 ...
 */
            ...
            <form id="update" name="update" method="POST" action="/admin/movies/update_action/<?php echo $data['movies_id']; ?>/" enctype="multipart/form-data">
                    ...
                    <div class="change-avatar img-upload">
                        <?php
                            ...
                            var importVideo = function(url){
                                ...
                                fetch('/admin/movies/import/<?php echo $data['movies_id']; ?>/', {
                                method: "POST", 
                                body: formdata
                                }).then(response => {
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                ...
                                if (event.target.files && event.target.files[0]) {
                                    ...
                                    var url = '/admin/movies/update_video/<?php echo $data['movies_id']; ?>/';
                    ...
                    <div class="setting-card">
                        <div class="row">
                            ...
                            <div class="form-wrap">
                                ...
                                <input type="text" class="form-control"  placeholder="" name="director" value="<?php echo $data['director']; ?>">
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-wrap">
