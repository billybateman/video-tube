	...
	<div class="container-fluid">
        ...
        <div class="dashboard-header">
            ...
            <ul class="header-list-btns">
                ...
                <li>
                    <a href="/admin/movies/create" class="content-loader btn btn-primary"><i class="fa fa-plus me-1"></i> Create</a>
                </li>
            </ul>
        </div>
                ...
                <div class="row">
                        ...
                        <table id="seasonTable" class="data-tables table custom-table movie_table dataTable no-footer" data-toggle="data-table" aria-describedby="seasonTable_info">
                            <thead>
                                <tr class="text-uppercase">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="seasonTable" rowspan="1" colspan="1" aria-label="Ratng: activate to sort column ascending">Rating</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex flex-column ms-3 justify-content-center">
                                                <h6 class="text-capitalize"><a href="/movies/watch/<?php echo $show->slug; ?>"><?php echo $show->name; ?></a></h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <small><?php echo $show->rating; ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <div class="form-check form-switch ms-2">
                                                <input id="fav_<?php echo $show->movies_id; ?>" onclick="toggleFeatured('<?php echo $show->movies_id; ?>');" class="form-check-input" type="checkbox" <?php if($show->featured){ ?>checked=""<?php } ?>>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <div class="form-check form-switch ms-2">
                                                <input id="status_<?php echo $show->movies_id; ?>" onclick="toggleStatus('<?php echo $show->movies_id; ?>');" class="form-check-input" type="checkbox" <?php if($show->status){ ?>checked=""<?php } ?>>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="action-item">
                                            <a href="/admin/movies/update/<?php echo $show->movies_id; ?>" class="content-loader" title="Update"><i class="fa-solid fa-pencil"></i>
                                            </a>
                                            <a href="javascript:void(0);" onclick="deleteshow('<?php echo $show->movies_id; ?>');" title="Delete"><i class="fa-solid fa-trash-can"></i>
                                            </a>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            ?>
                            <li class="page-item"><a class="page-link" href="<?php echo $url; ?>&start=0">1</a></li>
                            <?php
    ...
    var toggleFeatured = function(id){
        ...
        if ($('#fav_' + id).prop('checked')==true){ 
            featured = 1;
                    ...
                    $.ajax({ // create an AJAX call...
                        type: 'GET',
                        url: '/admin/movies/featured/' + id + '/' + featured,
                        processData: false,
                        contentType: false,
                        success: function(response) { // on success..
    ...
    var toggleStatus = function(id){
        ...
        if ($('#status_' + id).prop('checked')==true){ 
            status = 1;
                    ...
                    $.ajax({ // create an AJAX call...
                        type: 'GET',
                        url: '/admin/movies/status/' + id + '/' + status,
                        processData: false,
                        contentType: false,
                        success: function(response) { // on success..
