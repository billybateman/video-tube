	...
	<div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="setting-card">
                <form id="create" method="post" action="/admin/shows/create_action/" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-12">
                                    <div class="form-group px-3 ">
                                        ...
                                        <!-- toggle switch -->
                                        <!-- common inputs -->
                                        <input name="name" type="text" class="form-control " placeholder="Enter Show Name" value="" required>
                                    </div>                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group px-3 ">
                            ...
                            <div class="row mt-3 px-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="seasons" value="" class="form-control" required>    
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label flex-grow-1" for="access"><strong>Episodes:</strong></label>
                                    <div class="form-group">
                                        <input type="text" name="episodes" value="" class="form-control" required>    
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label flex-grow-1" for="genres"><strong>Episode Years:</strong></label>
                                        <input class="form-control" type="text" name="years" value="" placeholder="ie. 2022 - 2024" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
