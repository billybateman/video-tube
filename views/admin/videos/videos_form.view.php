<div class="content-body">
	...
	<div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <form id="update" name="update" method="POST" action="/admin/videos/create_action/" enctype="multipart/form-data">
                    ...
                    <div class="setting-card">
                        <div class="row">
                            ...
                            <div class="form-wrap">
                                ...
                                <input type="text" class="form-control"  placeholder="Some amazing video" name="title" value="" required>
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-wrap">
                            ...
                            <div class="form-wrap">
                                ...
                                <input type="text" class="form-control" placeholder="some-amazing-video" name="slug" value="" required>
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-wrap">
                                ...
                                <textarea class="form-control" name="description"  placeholder="This is one amazing video." required></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <input type="text" class="form-control"  placeholder="1" name="season" value="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-wrap">
                                            <label class="col-form-label">Episode</label>
                                            <input type="text" class="form-control" placeholder="1" name="episode" value="0">
                                        </div>
                                    </div>
