    ...
    <div class="container-fluid upload-details">
        <div class="row">
            ...
            <script type="text/javascript">
             ...
             <form id="update" method="post" action="/videos/update_action/<?php echo $data['videos_id']; ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Contrary to popular belief, Lorem Ipsum (2020) is not." name="title" value="<?php echo $data['title']; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="e2">About</label>
                                        <textarea rows="3"  class="form-control" name="description"><?php echo $data['description']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <select id="category" name="categoryId" type="select" class="form-control">
                                            <?php foreach($categories_data as $category){ ?>
                                                <option value="<?php echo $category->categories_id; ?>" <?php if($data['categoryId'] == $category->categories_id){ ?>selected<?php } ?>><?php echo $category->categories_name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
